                            ...
                            <div class="card-body">
                                ...
                                <div class="row fv-row mb-1">
                                    <div class="col-md-2 text-md-end">
                                        ...
                                        <div class="col-md-8">
                                            <!--begin::Input-->
                                            <select class="form-select form-select-solid" name="theme" data-control="select2" data-hide-search="false" data-placeholder="Select Company">
                                                <option></option>
                            ...
                            <div class="card-body">
                                ...
                                <div class="row fv-row mb-5">
                                    <div class="col-md-3 text-md-start">
                                        ...
                                        <div class="col-md-9">
                                            <!--begin::Input-->
                                            <input type="date" name="date" class="form-control form-control-solid" value="">
                                            <!--end::Input-->
                                        </div>
                        ...
                        <div class="card-body">
                            ...
                            <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_ecommerce_sales_table">
                                ...
                                <tbody class="fw-semibold text-gray-600">
                                    <tr>
                                        <td data-kt-ecommerce-order-filter="order_id">20-02-2023</td>
