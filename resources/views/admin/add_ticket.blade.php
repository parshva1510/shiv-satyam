            ...
            <div id="kt_app_toolbar_container" class="app-container new-full-width container-xxl d-flex flex-stack">
                ...
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    ...
                    <!--end::Title-->
                                            ...
                                            <label class="d-flex align-items-right fs-6 fw-bolder mb-2 required">Current Date</label>
                                            <!--begin::Input-->
                                            <div class="position-relative d-flex align-items-center">
                                                ...
                                                <!--end::Icon-->
                                                <!--begin::Datepicker-->
                                                <input class="form-control form-control-solid ps-12" id="date" placeholder="Select a date" name="date" value="{{!empty($transporter)?$transporter['curr_date']:''}}"/>
                                                <!--end::Datepicker-->
                                            </div>
